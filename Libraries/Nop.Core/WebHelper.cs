...
namespace Nop.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual string GetUrlReferrer()
        {
            ...
            //在某种情况下无效的URL链接 (for example, in IE 8)
        ...
        public virtual string GetCurrentIpAddress()
        {
            ...
            {
                //X-Forwarded-For（xff）的HTTP头字段是事实上的标准
                //用于识别客户机的源地址
                //连接到Web服务器通过HTTP代理或负载平衡器。
        ...
        /// 获取页面名称
        /// </summary>
        /// <param name="includeQueryString">标示是否包含查询字符串</param>
        ...
        /// <returns>如果请求目标是静态资源文件。返回真</returns>
        /// <remarks>
        /// 这些都是文件的扩展名被认为是静态资源:
        /// .css
        ///	.gif
        ...
        /// 映射一个虚拟路径到物理磁盘路径。
        /// </summary>
        /// <param name="path">需映射路径. E.g. "~/bin"</param>
